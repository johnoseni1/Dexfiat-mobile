...
<span>Pool</span></button></a>
                          ...
                          <div style={{marginLeft: "10px", width: "120px"}}>
                            <a href="/liquidity">
                            <button style={{color: "#009506", opacity: "0.5", fontSize: "13px", backgroundColor: "#DAAA02", border :"none", padding:"7px 11px", borderRadius: "5px"}}>Connect External Wallet</button></a>
                          </div>
...
<path d="M71.5 143C110.988 143 143 110.988 143 71.5C143 32.0116 110.988 0 71.5 0C32.0116 0 0 32.0116 0 71.5C0 110.988 32.0116 143 71.5 143Z" fill="#009506"/>
<path d="M131.675 33L68 98.0109L68.1125 105H71.0375L140 50.1957C137.975 44.0941 135.162 38.2142 131.675 33Z" fill="#076D0B"/>
<path d="M141.745 29.7043L129.135 17.251C127.461 15.583 124.671 15.583 122.886 17.251L68.9865 72.7346L45.6638 49.8296C43.9898 48.1617 41.2001 48.1617 39.4148 49.8296L28.2555 60.8374C26.5815 62.5054 26.5815 65.2851 28.2555 66.953L65.5273 103.757C66.5317 104.757 67.8708 105.091 69.2098 104.98C70.5489 105.091 71.8879 104.757 72.8924 103.757L141.745 35.9308C143.418 34.1516 143.418 31.3719 141.745 29.7043Z" fill="#F2F1EF"/>
<path d="M72.8248 103.757L141.743 35.9979C143.419 34.3316 143.419 31.5546 141.743 29.8883L139.733 28L69.027 97.0925L29.9323 59.2139L28.2567 60.8802C26.5811 62.5465 26.5811 65.3235 28.2567 66.9898L65.5644 103.758C66.5698 104.758 67.9101 105.091 69.2505 104.98C70.4791 105.09 71.8194 104.757 72.8248 103.757Z" fill="#E6E5E3"/>
</svg>
...
<div style={{display : "flex"}}>
    ...
    />}
                        <div style={{textAlign: "center", position : "relative", top: "30px", color : "#494949"}}>
                            Swap
                        </div>
                        <div className="talksinit">
                            ...
                            <div className="remain">
                                ...
                                <div className="down-now">
                                    ...
                                    <span className="this-guy"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16Z" fill="#8AC9FE"/>
<path d="M11.9694 1.05273C12.7975 2.31267 13.2797 3.82017 13.2797 5.44055C13.2797 9.85883 9.69799 13.4405 5.27971 13.4405C3.83515 13.4405 2.48008 13.0575 1.3103 12.3877C2.74015 14.5632 5.20211 15.9999 8.00002 15.9999C12.4183 15.9999 16 12.4182 16 7.99989C16 5.02617 14.3774 2.43158 11.9694 1.05273Z" fill="#60B7FF"/>
<path d="M8.00015 14.9661C11.8474 14.9661 14.9662 11.8473 14.9662 8.00003C14.9662 4.15276 11.8474 1.03394 8.00015 1.03394C4.15288 1.03394 1.03406 4.15276 1.03406 8.00003C1.03406 11.8473 4.15288 14.9661 8.00015 14.9661Z" fill="#EAF6FF"/>
<path d="M8.00044 11.8984C7.91503 11.8984 7.82962 11.8769 7.75259 11.8339L4.71644 10.139C4.55553 10.0492 4.45581 9.87931 4.45581 9.69502V6.30518C4.45581 6.1209 4.55553 5.95102 4.71644 5.86121L7.75259 4.16631C7.90665 4.08031 8.09422 4.08031 8.24828 4.16631L11.2844 5.86121C11.4453 5.95102 11.5451 6.1209 11.5451 6.30518V9.69502C11.5451 9.87931 11.4453 10.0492 11.2844 10.139L8.24828 11.8339C8.17125 11.8769 8.08584 11.8984 8.00044 11.8984ZM5.60675 9.47131L7.87303 10.7364C7.95222 10.7806 8.04865 10.7806 8.12784 10.7364L10.3941 9.47131C10.4768 9.42512 10.5281 9.33781 10.5281 9.24309V6.75709C10.5281 6.66237 10.4768 6.57503 10.3941 6.52887L8.12784 5.26374C8.04865 5.21952 7.95222 5.21952 7.87303 5.26374L5.60675 6.52887C5.52403 6.57506 5.47278 6.66237 5.47278 6.75709V9.24309C5.47275 9.33781 5.52403 9.42515 5.60675 9.47131Z" fill="#60B7FF"/>
<path d="M12.923 3.07129C13.1548 3.81998 13.2798 4.61563 13.2798 5.44051C13.2798 9.85879 9.69807 13.4405 5.27978 13.4405C4.62516 13.4405 3.9891 13.3613 3.38013 13.213C4.60969 14.3034 6.22741 14.966 8.00013 14.966C11.8474 14.966 14.9662 11.8471 14.9662 7.99988C14.9662 6.07479 14.1853 4.3321 12.923 3.07129Z" fill="#D8ECFE"/>
</svg>
<span style={{marginLeft: "10px"}}>Link</span></span>
                                </div>
                            </div>
